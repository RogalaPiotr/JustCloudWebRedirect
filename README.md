...
| To repozytorium zawiera kod źródłowy strony przekierowującej z głównej domeny **justcloud.pl** na dedykowaną stronę **web.justcloud.pl**. | This repository contains the source code for a redirect page from the main domain **justcloud.pl** to the dedicated website **web.justcloud.pl**. |
| Strona obsługuje podstawowe tagi SEO oraz integrację z Google Analytics. | The page handles basic SEO tags and Google Analytics integration. |
...
- **Main Website:** [web.justcloud.pl](https://web.justcloud.pl)
- **Blog:** [blog.justcloud.pl](https://blog.justcloud.pl)
- **RSS Feed:** [blog.justcloud.pl/rss.xml](https://blog.justcloud.pl/rss.xml)
